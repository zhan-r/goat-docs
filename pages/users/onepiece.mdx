...
### How to View Your Ranking —— Ranking page will launch on Early March

#### Accessing the Ranking Page

You can check your ranking on the ranking page, which is dynamically updated based on the GOAT Points and the number of invitations you have made.
